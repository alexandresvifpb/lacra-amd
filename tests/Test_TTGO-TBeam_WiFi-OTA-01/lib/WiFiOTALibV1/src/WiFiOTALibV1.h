#ifndef WIFIOTALIB0_H
#define WIFIOTALIB0_H
...
// #include <DNSServer.h>      // lib para web server (SSH)
// #include <TelnetSpy.h>      // lib para telnet (SSH)
