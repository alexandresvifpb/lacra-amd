...
#define MAIN_MESSAGE_INITIAL            ("D:\\downloads\\doutorado\\2019\\prototipos\\firmwares\\lacra-amd\\tests\\Test_TTGO-TBeam_BLE_WiFi-OTA-01.02")          // localizacao do projeto
...
TaskHandle_t TaskIdBLEWiFiOTA;

void TaskBLEWiFiOTA( void * pvParameters );
...
void setup() {
    ...
    xTaskCreatePinnedToCore(
                    TaskBLEWiFiOTA,     // Funcao com o codigo que implenta a Task
                    ...
                    &TaskIdBLEWiFiOTA,  // Referencia para acompanhar a Task
