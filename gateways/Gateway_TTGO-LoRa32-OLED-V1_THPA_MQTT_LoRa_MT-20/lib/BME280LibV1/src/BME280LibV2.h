...
#define THPA_TASK_DELAY_MS          (60000)
#define THPA_DEBUG_MESSAGE          ("THPA_TASK: ")
#define THPA_DEBUG_TIME_SERIAL      (60000)              // intervalo entre cada envio de uma string pela porta serial para debug da lib (em mili segundos)
