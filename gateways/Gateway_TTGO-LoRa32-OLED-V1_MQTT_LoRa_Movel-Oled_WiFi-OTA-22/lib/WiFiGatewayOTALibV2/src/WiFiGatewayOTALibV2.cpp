...
// Construtor da classe WiFiGatewayOTALib
WiFiGatewayOTALib::WiFiGatewayOTALib() {}
...
boolean WiFiGatewayOTALib::begin(void)
{
...
// Inputs: void
// Return: uint8_t
uint8_t WiFiGatewayOTALib::listenForClientsWS(void)
{
...
uint8_t WiFiGatewayOTALib::availableClientWS(void)
{
    /*
    // Serial.print(__FUNCTION__);
    // Serial.println(__LINE__);
...
uint8_t WiFiGatewayOTALib::availableRecvDataClientWS(void)
{
    if ( remoteClient.connected() )
    {
...
// Inputs: void
// Return: void
void WiFiGatewayOTALib::closeClientWS(void)
{
...
String WiFiGatewayOTALib::readClientWS(void)
{
    if ( remoteClient )
    {
...
// Return: void
void WiFiGatewayOTALib::printClientWS(String strValue)
{
...
String WiFiGatewayOTALib::getMacAddress(void) 
{
    char chipID_0[4];
    char chipID_1[4];
    char chipID_2[4];
...
// Inputs: void
// Return: boolean - TRUE caso seja estabelicida uma conexao WiFi
boolean WiFiGatewayOTALib::initSTA(void)
{
    // Serial.println(__LINE__);
...
boolean WiFiGatewayOTALib::isConnectedSTA(void)
{
...
// Inputs: void
// Return: void
void WiFiGatewayOTALib::disconnectSTA(void)
{
    webServer.stopAll();
...
// Inputs: void
// Return: boolean - TRUE rede wifi conectada
boolean WiFiGatewayOTALib::activeOTA(void)
{
    if ( connectedModeSTA ) {
...
boolean WiFiGatewayOTALib::bootServiceNTP(void)
{
    if ( WiFi.status() == WL_CONNECTED )
    {
        timeClient.begin();
...
// Inputs: void
// Return: boolean - TRUE se o cliente NTP foi inicilizado com sucesso
long WiFiGatewayOTALib::getUnixTimeNTP(void)
{
...
// Inputs: void
// Return: boolean - TRUE caso seja estabelicida uma conexao WiFi
boolean WiFiGatewayOTALib::initAP(void)
{
    // Serial.println(__LINE__);
...
// Inputs: void
// Return: boolean - TRUE se ativa
boolean WiFiGatewayOTALib::isConnectedAP(void)
{
    if ( (WiFi.softAPgetStationNum() >  0) )
    {
        connectedModeAP = true;
...
// Inputs: void
// Return: void
void WiFiGatewayOTALib::disconnectAP(void)
{
    webServer.stopAll();
