...
// Inputs: String
// Return: Config_t
Config_t ESP32NodeLib::getConfig(String strConfig) {
    Config_t _config;

    DynamicJsonDocument doc(1024);
    deserializeJson(doc, strConfig);

    _config.sdTaskDelayMS = doc["sdTaskDelayMS"];
    _config.loraTaskDelayMS = doc["loraTaskDelayMS"];
    _config.gpsTaskDelayMS = doc["gpsTaskDelayMS"];
    _config.imuTaskDelayMS = doc["imuTaskDelayMS"];
    _config.timeTaskDelayMS = doc["timeTaskDelayMS"];
...
// Inputs: Config_t
// Return: String
String ESP32NodeLib::getAllDatas(allDatas_t datas) {
    String rest;
