...
#define GPS_DEBUG_TIME_SERIAL   (2000)              // intervalo entre cada envio de uma string pela porta serial para debug da lib
...
class GPSLib
{
    public:
        ...
        uint16_t gpsDebugTimeSerial;
        uint16_t gpsTaskDelayMS;
        gps_t parametersGPS;
