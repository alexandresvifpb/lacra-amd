#ifndef WIFIOTALIBV3_H
#define WIFIOTALIBV3_H
...
#define WIFI_ASSID                      ("Node-")               // "brisa-594111";
#define WIFI_APASS                      ("12345678")            // "gbalklxz";
...
class WiFiOTALib
{
    public:
        ...
        boolean isConnectedSTAWiFi(void);
        int getNumberStationConnectedAP(void);
    ...
    private:
        ...
        boolean wifiAPConnected = false;

        String wifi_assid = WIFI_ASSID;
        String wifi_apass = WIFI_APASS;
        boolean wifiSTAConnected = false;
